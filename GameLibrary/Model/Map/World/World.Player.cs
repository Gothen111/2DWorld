                    ...
                    if (var_World != null && var_Region != null && var_Chunk != null)
                    {
                        ...
                        for (int x = -var_Range / 2; x <= var_Range / 2; x++)
                        {
                            for (int y = -var_Range / 2; y <= var_Range / 2; y++)
                            {
                                ...
                                {
                                    var_World.createPlayerObjectNeighbourChunk(new Vector2((int)var_Chunk.Position.X + x * Chunk.Chunk.chunkSizeX * Block.Block.BlockSize, (int)var_Chunk.Position.Y + y * Chunk.Chunk.chunkSizeY * Block.Block.BlockSize));
                                }
                            }
                        }
                    }
