/*
 * Quelle: http://www.codeproject.com/Articles/118015/Fast-A-Star-D-Implementation-for-C
 * Verbesserung: I traced it a bit, and it seems that your priority queue implementation is a rather straightforward one.
 * By replacing it with a binary min-heap I grabbed from here, the computation time went from ~2.2 sec. to ~1.7 sec. in the case of a 1024 * 1024 grid.
 * If anyone need this speed up, just replace the original priority queue with the heap in the link above.
 * Link : http://www.informit.com/guides/content.aspx?g=dotnet&seqNum=789
 * 
 */
...
namespace GameLibrary.Model.Path.AStar.COPY
{
