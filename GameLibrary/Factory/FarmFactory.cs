    ...
    public class FarmFactory
    {
        ...
        public void generateFarms(Region _Region, int _MaxCount, int _MinDistance)
        {
            ...
            for (int i = 0; i < var_Count; i++)
            {
                ...
                ((Model.Map.World.World)_Region.Parent).addLivingObject(var_EnvironmentObject,true, _Region); // Region wird erst world zugewiesen. dannach könne erst objetek hin :(
            }
        }
    }
}
