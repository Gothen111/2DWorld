...
using Client.Model.Object.ObjectEnums;
    ...
    class AnimatedObject: Object
    {
        ...
        private void move()
        {
            ...
            if (var_X != 0 || var_Y != 0)
            {
                ...
                List<LivingObject> objectsColliding = Model.Map.World.World.world.getObjectsColliding(nextBounds); // World.getObjectsColliding(nextBounds);
